...
class ModuleCode extends CCodeModel
{
	...
	{
		if(Mod::app()->hasModule($this->moduleID))
			return 'The module has been generated successfully. You may '.CHtml::link('try it now', Mod::app()->createUrl($this->moduleID), array('target'=>'_blank')).'.';
...
EOD;
	...
	{
		return Mod::app()->modulePath.DIRECTORY_SEPARATOR.$this->moduleID;
	}
}