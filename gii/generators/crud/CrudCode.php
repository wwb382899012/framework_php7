...
class CrudCode extends CCodeModel
{
	...
	{
		$link=CHtml::link('try it now', Mod::app()->createUrl($this->controller), array('target'=>'_blank'));
	...
	public function validateModel($attribute,$params)
	{
		if($this->hasErrors('model'))
			return;
		$class=@Mod::import($this->model,true);
	...
	public function getModule()
	{
		if(($pos=strpos($this->controller,'/'))!==false)
		{
			...
			if(($module=Mod::app()->getModule($id))!==null)
				return $module;
		}
		return Mod::app();
	}
