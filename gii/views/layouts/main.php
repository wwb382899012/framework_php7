...
<div class="container" id="page">
	<div id="header">
		<div class="top-menus">
		<?php echo CHtml::link('help','http://www.modframework.com/doc/guide/topics.gii'); ?> |
		<?php echo CHtml::link('webapp',Mod::app()->homeUrl); ?> |
		<a href="http://www.modframework.com">mod</a>
		<?php if(!Mod::app()->user->isGuest): ?>
...
<div id="footer">
	...
	<br/>A product of <a href="http://www.modsoft.com">Mod Software LLC</a>.
</div><!-- footer -->
