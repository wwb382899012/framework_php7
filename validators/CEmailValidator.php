...
class CEmailValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->message!==null?$this->message:Mod::t('mod','{attribute} is not a valid email address.');
	 ...
	 * @since 1.1.1
	 * @see https://github.com/modsoft/mod/issues/3764#issuecomment-75457805
	 */
	...
	public function clientValidateAttribute($object,$attribute)
	{
		if($this->validateIDN)
		{
			Mod::app()->getClientScript()->registerCoreScript('punycode');
...
";
	...
	private function encodeIDN($value)
	{
		if(preg_match_all('/^(.*)@(.*)$/',$value,$matches))
		{
			...
			{
				require_once(Mod::getPathOfAlias('system.vendors.Net_IDNA2.Net').DIRECTORY_SEPARATOR.'IDNA2.php');
				$idna=new Net_IDNA2();
