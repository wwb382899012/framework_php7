 ...
 * It is the result of merging commonly used Mod class files with
 * comments and trace statements removed away.
 *
 * By using this file instead of mod.php, an Mod application may
...
class CDbConnection extends CApplicationComponent
{
	...
	protected function createPdoInstance()
	{
		...
		if(!$instance)
			throw new CDbException(Mod::t('mod','CDbConnection failed to open the DB connection.'));
		return $instance;
	}
