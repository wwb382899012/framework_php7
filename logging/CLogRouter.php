...
class CLogRouter extends CApplicationComponent
{
	...
	public function init()
	{
		...
		{
			$route=Mod::createComponent($route);
			$route->init();
			$this->_routes[$name]=$route;
		}
		Mod::getLogger()->attachEventHandler('onFlush',array($this,'collectLogs'));
		Mod::app()->attachEventHandler('onEndRequest',array($this,'processLogs'));
	}
