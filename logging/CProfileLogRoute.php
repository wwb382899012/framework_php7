 ...
 *
 * The profiling is done by calling {@link ModBase::beginProfile()} and {@link ModBase::endProfile()},
...
class CProfileLogRoute extends CWebLogRoute
{
	...
	public function setReport($value)
	{
		if($value==='summary' || $value==='callstack')
			...
			throw new CException(Mod::t('mod','CProfileLogRoute.report "{report}" is invalid. Valid values include "summary" and "callstack".',
				array('{report}'=>$value)));
	}
	 ...
	 * @throws CException if Mod::beginProfile() and Mod::endProfile() are not matching
	 */
