...
use ReflectionClass;
use system\components\base\InvalidConfigException;
use system\components\helpers\ArrayHelper;
...
class Container extends \CComponent
{
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('system\components\base\Configurable')) {
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (\Mod::app() && \Mod::app()->hasComponent($name) && ($obj = \Mod::app()->getComponent($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
