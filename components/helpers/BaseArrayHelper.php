...
namespace system\components\helpers;

use system\components\base\Arrayable;
use system\components\base\InvalidArgumentException;
...
class BaseArrayHelper
{
    ...
    {
        if ($charset === null) {
            $charset = \Mod::app() ? \Mod::app()->charset : 'UTF-8';
        }
        $d = [];
