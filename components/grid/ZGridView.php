...
Mod::import('system.components.grid.ZAColumn');
Mod::import('system.components.grid.ZDataColumn');
Mod::import('system.components.grid.ZEnumColumn');
Mod::import('system.components.grid.ZMoneyColumn');
...
class ZGridView extends CGridView
{
    ...
    /**
     * 显示分页信息，如果pager是函数，会自动调用并传入分页相关的参数
     */
    public function renderPager()
    {
        if(is_callable($this->pager))
        {
            ...
            return parent::renderPager(); // TODO: Change the autogenerated stub
    }
