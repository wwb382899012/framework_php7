...
class CSqliteSchema extends CDbSchema
{
	...
	{
		throw new CDbException(Mod::t('mod', 'Dropping DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Renaming a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Adding a foreign key constraint to an existing table is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Dropping a foreign key constraint is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Altering a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Adding a primary key after table has been created is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(Mod::t('mod', 'Removing a primary key after table has been created is not supported by SQLite.'));
