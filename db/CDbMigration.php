 ...
 *
 * CDbMigration is designed to be used together with the "modc migrate" command.
 *
 ...
 * logic. The "modc migrate" command manages all available migrations in an application.
 *
...
abstract class CDbMigration extends CComponent
{
	...
	public function getDbConnection()
	{
		if($this->_db===null)
		{
			$this->_db=Mod::app()->getComponent('db');
			if(!$this->_db instanceof CDbConnection)
				throw new CException(Mod::t('mod', 'The "db" application component must be configured to be a CDbConnection object.'));
		}
		return $this->_db;
	}
