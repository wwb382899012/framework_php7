...
Mod::import('zii.widgets.jui.CJuiWidget');
 ...
 * with {@link CJavaScriptExpression} and Mod will use it as code.
 *
 * @author Sebastian Thierer <sebathi@gmail.com>
...
class CJuiSortable extends CJuiWidget
{
	...
	public function run()
	{
		...
		Mod::app()->getClientScript()->registerScript(__CLASS__.'#'.$id,"jQuery('#{$id}').sortable({$options});");
