...
abstract class CJuiWidget extends CWidget
{
	 ...
	 * If this property is not set (default), Mod will publish the JUI package included in the zii release and use
	...
	{
		Mod::app()->getClientScript()->registerScriptFile($this->scriptUrl.'/'.$fileName,$position);
	}
}