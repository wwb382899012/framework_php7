	...
	*/
	...
	public function init()
	{
		if($this->itemView===null)
			throw new CException(Mod::t('zii','The property "itemView" cannot be empty.'));
		parent::init();
		...
		if($this->baseScriptUrl===null)
			$this->baseScriptUrl=Mod::app()->getAssetManager()->publish(Mod::getPathOfAlias('zii.widgets.assets')).'/listview';
	...
	public function registerClientScript()
	{
		...
		$cs->registerScriptFile($this->baseScriptUrl.'/jquery.modlistview.js',CClientScript::POS_END);
		$cs->registerScript(__CLASS__.'#'.$id,"jQuery('#$id').modListView($options);");
	}
	...
	public function renderSorter()
	{
		...
		echo $this->sorterHeader===null ? Mod::t('zii','Sort by: ') : $this->sorterHeader;
		echo "<ul>\n";
