 ...
 * the mod-dbmigrations extension ((https://github.com/pieterclaerhout/mod-dbmigrations),
...
class MigrateCommand extends CConsoleCommand
{
	...
	{
		$path=Mod::getPathOfAlias($this->migrationPath);
		...
		echo "\nMod Migration Tool v1.0 (based on Mod v{$modVersion})\n\n";
	...
	protected function getDbConnection()
	{
		if($this->_db!==null)
			return $this->_db;
		elseif(($this->_db=Mod::app()->getComponent($this->connectionID)) instanceof CDbConnection)
			return $this->_db;
...
EXAMPLES
 * modc migrate
   Applies ALL new migrations. This is equivalent to 'modc migrate up'.

 * modc migrate create create_user_table
 ...
 * modc migrate to 101129_185401
   Migrates up or down to version 101129_185401.

 * modc migrate to 1392447720
 ...
 * modc migrate to "2014-02-15 13:00:50"
...
EOD;
	...
	protected function getTemplate()
	{
		if($this->templateFile!==null)
			return file_get_contents(Mod::getPathOfAlias($this->templateFile).'.php');
		else
			return <<<EOD
<?php
