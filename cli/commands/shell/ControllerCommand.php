...
Mod is able to detect whether 'admin' refers to a module or a subdirectory.
...
EOD;
	...
	public function run($args)
	{
		...
		$templatePath=$this->templatePath===null?MOD_PATH.'/cli/views/shell/controller':$this->templatePath;
...
EOD;
	...
	public function generateController($source,$params)
	{
		if(!is_file($source))  // fall back to default ones
			$source=MOD_PATH.'/cli/views/shell/controller/'.basename($source);
