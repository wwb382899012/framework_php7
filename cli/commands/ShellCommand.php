...
class ShellCommand extends CConsoleCommand
{
	...
	public function getHelp()
	{
		return <<<EOD
USAGE
  modc shell [entry-script | config-file]
...
EOD;
	...
	public function run($args)
	{
		...
		Mod::setApplication(null);
		Mod::setPathOfAlias('application',null);
		...
		echo <<<EOD
Mod Interactive Tool v1.1 (based on Mod v{$modVersion})
...
EOD;
	...
	{
		$runner->addCommands(Mod::getPathOfAlias('system.cli.commands.shell'));
		$runner->addCommands(Mod::getPathOfAlias('application.commands.shell'));
