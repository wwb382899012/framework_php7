...
class CDbCache extends CCache
{
	 ...
	 * is <code>protected/runtime/cache-ModVersion.db</code>.
	 */
	public $connectionID;
	/**
	 * @var string name of the DB table to store cache content. Defaults to 'ModCache'.
	 ...
	 */
	public $cacheTableName='ModCache';
	/**
	...
	public function getDbConnection()
	{
		...
		elseif(($id=$this->connectionID)!==null)
		{
			if(($this->_db=Mod::app()->getComponent($id)) instanceof CDbConnection)
				...
				throw new CException(Mod::t('mod','CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
					array('{id}'=>$id)));
		}
		else
		{
			$dbFile=Mod::app()->getRuntimePath().DIRECTORY_SEPARATOR.'cache-'.Mod::getVersion().'.db';
