...
class CDbCacheDependency extends CCacheDependency
{
	...
	protected function generateDependentData()
	{
		if($this->sql!==null)
		{
			...
			throw new CException(Mod::t('mod','CDbCacheDependency.sql cannot be empty.'));
	}
	...
	protected function getDbConnection()
	{
		...
		{
			if(($this->_db=Mod::app()->getComponent($this->connectionID)) instanceof CDbConnection)
				return $this->_db;
			else
				throw new CException(Mod::t('mod','CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
