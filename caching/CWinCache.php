...
class CWinCache extends CCache {
	...
	public function init()
	{
		...
		if(!extension_loaded('wincache'))
			throw new CException(Mod::t('mod', 'CWinCache requires PHP wincache extension to be loaded.'));
		if(!ini_get('wincache.ucenabled'))
			throw new CException(Mod::t('mod', 'CWinCache user cache is disabled. Please set wincache.ucenabled to On in your php.ini.'));
	}
