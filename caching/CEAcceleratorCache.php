...
class CEAcceleratorCache extends CCache
{
	...
	public function init()
	{
		...
		if(!function_exists('eaccelerator_get'))
			throw new CException(Mod::t('mod','CEAcceleratorCache requires PHP eAccelerator extension to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.'));
	}
