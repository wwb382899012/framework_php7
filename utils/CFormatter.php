 ...
 * Therefore, one may call <code>Mod::app()->format->boolean(1)</code>.
...
class CFormatter extends CApplicationComponent
{
	...
	public function format($value,$type)
	{
		...
		if(method_exists($this,$method))
			...
			throw new CException(Mod::t('mod','Unknown type "{type}".',array('{type}'=>$type)));
	}
	...
	public function formatSize($value,$verbose=false)
	{
		...
		{
			case 0:
				return $verbose ? Mod::t('mod','{n} byte|{n} bytes',$params) : Mod::t('mod', '{n} B',$params);
			case 1:
				return $verbose ? Mod::t('mod','{n} kilobyte|{n} kilobytes',$params) : Mod::t('mod','{n} KB',$params);
			case 2:
				return $verbose ? Mod::t('mod','{n} megabyte|{n} megabytes',$params) : Mod::t('mod','{n} MB',$params);
			case 3:
				return $verbose ? Mod::t('mod','{n} gigabyte|{n} gigabytes',$params) : Mod::t('mod','{n} GB',$params);
			default:
				return $verbose ? Mod::t('mod','{n} terabyte|{n} terabytes',$params) : Mod::t('mod','{n} TB',$params);
		}
	}
}
