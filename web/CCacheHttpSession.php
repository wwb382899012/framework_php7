...
class CCacheHttpSession extends CHttpSession
{
	 ...
	 */
	const CACHE_KEY_PREFIX='Mod.CCacheHttpSession.';
	/**
	...
	{
		$this->_cache=Mod::app()->getComponent($this->cacheID);
		if(!($this->_cache instanceof ICache))
			throw new CException(Mod::t('mod','CCacheHttpSession.cacheID is invalid. Please make sure "{id}" refers to a valid cache application component.',
	 ...
	 * {@link https://github.com/modsoft/mod/issues/4020}
	 *
	 * @param string $id session ID
