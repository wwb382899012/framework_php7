...
class COutputCache extends CFilterWidget
{
	 ...
	 */
	const CACHE_KEY_PREFIX='Mod.COutputCache.';
	 ...
	 * A language is retrieved via Mod::app()->language.
	 * Defaults to false.
	 * @since 1.1.14
	 */
	...
	public function run()
	{
		...
		elseif($this->_cache!==null)
		{
			...
			if(is_array($this->dependency))
				$this->dependency=Mod::createComponent($this->dependency);
	...
	{
		if((empty($this->requestTypes) || in_array(Mod::app()->getRequest()->getRequestType(),$this->requestTypes))
	...
	{
		return Mod::app()->getComponent($this->cacheID);
	}
	...
	protected function getCacheKey()
	{
		...
		else
		{
			...
			if($this->varyBySession)
				$key.=Mod::app()->getSession()->getSessionID();
			$key.='.';
	...
	protected function replayActions()
	{
		...
		foreach($this->_actions as $action)
		{
			...
			elseif($action[0]==='' && function_exists($action[1]))
				...
				throw new CException(Mod::t('mod','Unable to replay the action "{object}.{method}". The method does not exist.',
