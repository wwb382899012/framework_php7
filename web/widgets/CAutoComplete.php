 ...
 *
 * This class is deprecated since Mod 1.1.3. Consider using CJuiAutoComplete.
...
class CAutoComplete extends CInputWidget
{
	...
	public function registerClientScript()
	{
		...
		$cs->registerScript('Mod.CAutoComplete#'.$id,"jQuery(\"#{$id}\").legacyautocomplete($data,{$options}){$this->methodChain};");
