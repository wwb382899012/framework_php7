...
class CCaptchaAction extends CAction
{
	 ...
	 */
	const SESSION_VAR_PREFIX='Mod.CCaptchaAction.';
	/**
	...
	public $offset = -2;
	/**
	 * @var string the TrueType font file. Defaults to SpicyRice.ttf which is provided with the Mod release.
	...
	{
		return self::SESSION_VAR_PREFIX . Mod::app()->getId() . '.' . $this->getController()->getUniqueId() . '.' . $this->getId();
	}
