...
class CLinkPager extends CBasePager
{
	...
	public function init()
	{
		if($this->nextPageLabel===null)
			$this->nextPageLabel=Mod::t('mod','Next &gt;');
		if($this->prevPageLabel===null)
			$this->prevPageLabel=Mod::t('mod','&lt; Previous');
		if($this->firstPageLabel===null)
			$this->firstPageLabel=Mod::t('mod','&lt;&lt; First');
		if($this->lastPageLabel===null)
			$this->lastPageLabel=Mod::t('mod','Last &gt;&gt;');
		if($this->header===null)
			$this->header=Mod::t('mod','Go to page: ');

		if(!isset($this->htmlOptions['id']))
			$this->htmlOptions['id']=$this->getId();
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='modPager';
	}
	...
	{
		if($url===null)
			$url=CHtml::asset(Mod::getPathOfAlias('system.web.widgets.pagers.pager').'.css');
		Mod::app()->getClientScript()->registerCssFile($url);
	}
}
