...
class CTabView extends CWidget
{
	...
	public function registerClientScript()
	{
		...
		$cs->registerCoreScript('modtab');
		$id=$this->getId();
		$cs->registerScript('Mod.CTabView#'.$id,"jQuery(\"#{$id}\").modtab();");
	...
	public static function registerCssFile($url=null)
	{
		$cs=Mod::app()->getClientScript();
		if($url===null)
			$url=$cs->getCoreScriptUrl().'/modtab/jquery.modtab.css';
