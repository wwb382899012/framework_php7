...
class CActiveForm extends CWidget
{
	...
	public function run()
	{
		...
		$cs->registerCoreScript('modactiveform');
		$id=$this->id;
		$cs->registerScript(__CLASS__.'#'.$id,"jQuery('#$id').modactiveform($options);");
	}
	 ...
	 * </ul>
	 * This should NOT be a function but just the code, Mod will enclose the code you provide inside the
	 * actual JS function.
