...
'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'A CProfileLogRoute nem egyező kód-blokkot talált "{token}". Kérjük, győződjön meg róla, hogy a Mod:beginProfile és Mod:endProfile hívásai megfelelően vannak beágyazva.',
...
'Mod application can only be created once.' => 'Mod alkalmazást csak egyszer lehet létrehozni',
