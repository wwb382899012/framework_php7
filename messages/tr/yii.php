...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute eşleşmeyen bir kod bloğu buldu "{token}". Mod::beginProfile() ve Mod::endProfile() methodlarına yapılan call isteklerinin düzgün bir şekilde sıralandığına (nested) emin olun. ',
  ...
  'Mod application can only be created once.' => 'Mod uygulaması yanlızca bir kez oluşturulabilir.',
