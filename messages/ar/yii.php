...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute عثر على الكتلة البرمجية "{token}" الغير مطابقة. تأكد من أن النداءات إلى Mod::beginProfile() و Mod::endProfile() متداخلة بشكل صحيح.',
  ...
  'Powered by {mod}.' => 'مشغل بواسطة {mod}.',
  ...
  'Yes' => 'نعم',
  'Mod application can only be created once.' => 'تطبيق Mod يمكن إنشاؤه مرة واحدة فقط.',
