...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute พบคำสั่งที่ห้ามใช้งาน "{token}". กรุณาตรวจสอบว่าการเรียกใช้งาน Mod::beginProfile() และ Mod::endProfile() จะต้องถูกระบุคุณสมบัติต่างๆที่ถูกต้อง',
  ...
  'Mod application can only be created once.' => 'โปรแกรม Mod สามารถสร้างได้เพียงครั้งเดียวเท่านั้น',
