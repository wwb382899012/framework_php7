...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute tìm thấy đoạn code code không đúng "{token}". Hãy chắc rằng các call tới Mod::beginProfile() và Mod::endProfile() phải được nest một cách đúng đắn.',
  ...
  'Mod application can only be created once.' => 'Mod application chỉ có thể được tạo một lần.',
