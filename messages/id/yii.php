...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute menemukan blok kode tidak sama "{token}". Pastikan panggilan Mod::beginProfile() dan Mod::endProfile() di-nested dengan benar.',
  ...
  'Mod application can only be created once.' => 'Aplikasi Mod hanya bisa dibuat satu kali.',
