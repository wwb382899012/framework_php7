...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute upptäckte ett omatchat kodblock "{token}". Anropen till Mod::beginProfile() och Mod::endProfile() måste vara korrekt nästlade.',
  ...
  'Mod application can only be created once.' => 'Mod applikation kan bara ha en enda instans.',
