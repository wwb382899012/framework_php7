...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute found a mismatching code block "{token}". 请确定对于 Mod::beginProfile() 与 Mod::endProfile() 的呼叫是适当地巢状套叠的.',
  ...
  'Mod application can only be created once.' => 'Mod 应用程序只能被产生一次.',
