...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute löysi yhteensopimattoman koodilohkon "{token}". Varmista, että Mod::beginProfile() ja Mod::endProfile() -kutsut on sisennetty oikein.',
  ...
  'Yes' => 'Kyllä',
  'Mod application can only be created once.' => 'Mod-sovellus voidaan luoda vain kerran.',
