...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'பொருந்தாத "{token}" நிரல் குழுவை CProfileLogRoute கண்டுபிடித்துள்ளது. Mod::beginProfile() மற்றும் Mod::endProfile() அழைப்புகள் ஒழுங்கான சங்கிலியில் அமைந்துள்ளதா என்று சரிபார்க்கவும்.',
  ...
  'Mod application can only be created once.' => 'Mod அங்கத்தை ஒருமுறைதான் உருவாக்க முடியும்.',
