...
return array (
  ...
  'Can\'t create state persister table. Check CREATE privilege for \'{db}\' connection user or create table manually with SQL: {sql}.' => 'Die Tabelle für den CDbStatePersister konnte nicht angelegt werden. Prüfen Sie die CREATE-Rechte für den Benutzer der Verbindung \'{db}\', oder erstellen Sie die Tabelle manuell mit dem folgenden SQL-Befehl: {sql}.',
  'Encryption key length can be {keyLengths}.' => 'Die Schlüssellänge kann folgende Werte annehmen: {keyLengths}.',
  'Encryption key length must be between {minLength} and {maxLength}.' => 'Die Schlüssellänge muss zwischen {minLength} und {maxLength} liegen.',
  'Encryption key should be a string.' => 'Der Schlüssel muss als String gegeben werden.',
  'Failed to validate key. Supported key lengths of cipher not known.' => 'Der Schlüssel konnte nicht validiert werden. Die Verfügbaren Schlüssellängen sind unbekannt.',
  'No encryption key specified.' => 'Es wurde kein Schlüssel angegeben.',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute fand einen unzugehörigen Code-Block "{token}". Stellen Sie sicher dass Aufrufe von Mod::beginProfile() und Mod::endProfile() richtig verschachtelt sind.',
  ...
  'Yes' => 'Ja',
  'Mod application can only be created once.' => 'Eine Mod Applikation kann nur einmal erzeugt werden.',
