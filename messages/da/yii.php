...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute fandt en mismatchende kodeblock "{token}". Tjek at kaldene til Mod::beginProfile() og Mod::endProfile() er korrekt indlejret.',
  ...
  'Yes' => 'Ja',
  'Mod application can only be created once.' => 'Mod-applikationen kan kun oprettes en gang.',
