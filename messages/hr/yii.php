...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute je našao neusaglašen blok koda "{token}". Budite sigurni da su pozivi Mod::beginProfile() i Mod::endProfile() ispravno ugnježdeni.',
  ...
  'The view path "{path}" is not a valid directory.' => 'Put do prikaznog direktorija (view path) "{path}" nije važeći.',
  ...
  'Mod application can only be created once.' => 'Mod aplikacija može biti kreirana samo jedanput.',
