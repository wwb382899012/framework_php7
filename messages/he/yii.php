...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute מצא בלוק אשר לא תואם בשרשור שלו "{token}". אנא וודא שקריאות ל Mod::beginProfile() ו Mod::endProfile() משורשרות בהתאם.',
  ...
  'Mod application can only be created once.' => 'ניתן ליצור אפליקציה רק פעם אחת.',
