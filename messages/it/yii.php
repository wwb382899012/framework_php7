...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute ha trovato un blocco di codice "{token}" disallineato. Verificare che le chiamate a Mod::beginProfile() e a Mod::endProfile() siano correttamente annidate.',
  ...
  'Mod application can only be created once.' => 'Si può creare una sola applicazione Mod.',
