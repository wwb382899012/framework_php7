...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute found a mismatching code block "{token}". 請確定對於 Mod::beginProfile() 與 Mod::endProfile() 的呼叫是適當地巢狀套疊的.',
  ...
  'Mod application can only be created once.' => 'Mod 應用程式只能被產生一次.',
