...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute が整合の取れないコードブロック "{token}" を見つけました。Mod::beginProfile() と Mod::endProfile()の呼び出しが正しくネストされているか確認してください。',
  ...
  'Yes' => 'はい',
  'Mod application can only be created once.' => 'Modアプリケーションは一度しか作成できません。',
