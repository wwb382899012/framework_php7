...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute encontrou uma combinação errada no bloco de código "{token}". Tente chamar Mod::beginProfile() e Mod::endProfile() para ser apropriadamente aninhado.',
  ...
  'Mod application can only be created once.' => 'A aplicação Mod só pode ser criada uma vez.',
