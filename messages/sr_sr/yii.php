...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute је нашао неусаглашен блок кода "{token}". Будите сигурни да су позиви Mod::beginProfile() и Mod::endProfile() исправно угњеждени.',
  ...
  'Mod application can only be created once.' => 'Mod апликација може бити креирана само једанпут.',
