...
return array (
  ...
  'Powered by {mod}.' => 'Potenciat per {mod}.',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute ha trobat un bloc de codi "{token}" desalineat. Asseguri\'s de que las crides a Mod::beginProfile() i a Mod::endProfile() estan correctament anidades.',
  ...
  'Mod application can only be created once.' => 'Només es pot crear una aplicació Mod.',
