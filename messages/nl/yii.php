...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute heeft een niet overeenkomstig cod blok "{token}" gevonden. Zorg ervoor dat alle aanroepen naar Mod::beginProfile() en Mod::endProfile() correct genesteld zijn.',
  ...
  'Powered by {mod}.' => 'Aangedreven door {mod}.',
  ...
  'Yes' => 'Ja',
  'Mod application can only be created once.' => 'Er kan slechts 1 Mod applicatie aangemaakt worden.',
