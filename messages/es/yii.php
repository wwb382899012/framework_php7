...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute ha encontrado un bloque de código "{token}" no coincidente. Asegúrese que las llamadas a Mod::beginProfile() y a Mod::endProfile() esten correctamente anidadas.',
  ...
  'Powered by {mod}.' => 'Potenciado por {mod}.',
  ...
  'Yes' => 'Si',
  'Mod application can only be created once.' => 'La aplicación Mod puede ser creada solo una vez.',
