...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'Компонент CProfileLogRoute виявив невірний код "{token}". Переконайтесь, що вкладеність викликів Mod::beginProfile() та Mod::endProfile() дотримується.',
  ...
  'Mod application can only be created once.' => 'Додаток Mod може бути створено тільки один раз.',
