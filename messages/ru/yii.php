...
return array (
  ...
  'CCaptchaValidator.action "{id}" is invalid. Unable to find such an action in the current controller.' => 'Действие CCaptchaValidator.action "{id}" задано неверно: действие не найдено в текущем контроллере.',
  ...
  'CHttpCacheFilter.lastModified contained a value that could not be understood by strtotime()' => 'CHttpCacheFilter.lastModified содержит значение, которое не удалось разобрать при помощи strtotime()',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'Компонент CProfileLogRoute обнаружил неверный код "{token}". Удостоверьтесь, что вложенность вызовов Mod::beginProfile() и Mod::endProfile() соблюдается.',
  ...
  'Yes' => 'Да',
  'Mod application can only be created once.' => 'Приложение Mod может быть создано только один раз.',
  ...
  '{class} requires the PHP crypt() function. This system does not have it.' => '{class} требует наличия отсутствующей в вашей системе функции PHP crypt().',
