...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute natrafił na błędny blok kodu "{token}". Upewnij się, że wywołania Mod::beginProfile() i Mod::endProfile() są poprawnie zagnieżdżone.',
  ...
  'Mod application can only be created once.' => 'Aplikacja Mod może być utworzona tyko raz.',
