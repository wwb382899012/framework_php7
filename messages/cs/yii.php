...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute zjistil nesprávně uspořádané bloky kódu "{token}". Ujistěte se, že volání Mod::beginProfile() a Mod::endProfile() jsou vložené správně.',
  ...
  'Mod application can only be created once.' => 'Mod aplikace může být vytvořená pouze jednou.',
