...
return array (
  'Powered by {mod}.' => 'Задвижван от {mod}.',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute намери несъответстващ блок от код "{token}". Моля, проверете дали обръщането към Mod::beginProfile() и Mod::endProfile() е вложено правилно.',
  ...
  'Mod application can only be created once.' => 'Mod приложението може да бъде стартирано само веднъж',
