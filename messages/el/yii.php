...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'Το CProfileLogRoute βρήκε ένα τμήμα κώδικα "{token}" που δεν ταιριάζει. Επιβεβαιώστε ότι οι κλήσεις στο Mod::beginProfile() και Mod::endProfile() είναι σωστά φωλιασμένες.',
  ...
  'Powered by {mod}.' => 'Ο ιστοτόπος τρέχει {mod}.',
  ...
  'Mod application can only be created once.' => 'Η εφαρμογή Mod μπορεί να δημιουργηθεί μία μόνο φορά.',
