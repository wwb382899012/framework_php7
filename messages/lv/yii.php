...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute konstatēja nekorektu koda bloku "{token}". Pārliecinieties, ka ir atbilstoši Mod::beginProfile() un Mod::endProfile() izsaukumi.',
  ...
  'Mod application can only be created once.' => 'Mod lietojumprogramma var tikt inicializēta tikai vienu reizi.',
