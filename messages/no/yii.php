...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute fant en mismatchende kodeblock "{token}". Sjekk at kallene til  Mod::beginProfile() og Mod::endProfile() er riktig nøstet.',
  ...
  'Mod application can only be created once.' => 'Mod-applikasjonen kan bare opprettes en gang.',
