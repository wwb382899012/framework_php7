...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute a găsit un bloc de cod nepotrivit "{token}". Asiguraţi-vă că apelurile Mod::beginProfile() şi Mod::endProfile() sunt îmbricate corespunzător.',
  ...
  'Mod application can only be created once.' => 'Aplicatia Mod poate fi creată doar o dată.',
