...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute a trouvé un bloc de code « {token} » incorrect. Vérifiez que les appels à Mod::beginProfile() et à Mod::endProfile() sont correctement imbriqués.',
  ...
  'Mod application can only be created once.' => 'Une seule application Mod peut être créée.',
