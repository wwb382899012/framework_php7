...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute компоненті қате "{token}" кодын анықтады. Mod::beginProfile() мен Mod::endProfile() шақырулардың ішке салынуы дұрыстығын тексеріңіз.',
  ...
  'Mod application can only be created once.' => 'Mod қолданбасы тек бір рет жасалуы мүмкін.',
