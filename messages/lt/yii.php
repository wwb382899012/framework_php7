...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute rado neteisingą kodo bloką „{token}“. Pasitikslinkite, ar Mod::beginProfile() ir Mod::endProfile() kvietimai teisingai įdėti.',
  ...
  'Mod application can only be created once.' => 'Mod programa gali būti sukurta tik vieną kartą.',
