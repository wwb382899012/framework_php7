...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute zistil nesprávne usporiadané bloky kódu "{token}". Ubezpečte sa, že volania Mod::beginProfile() a Mod::endProfile() sú vložené správne.',
  ...
  'Yes' => 'Áno',
  'Mod application can only be created once.' => 'Mod aplikácia môže byť vytvorená len jeden raz.',
