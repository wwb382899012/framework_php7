...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mod::beginProfile() and Mod::endProfile() be properly nested.' => 'CProfileLogRoute가 일치하지 않는 코드 블록 "{token}"를 찾았습니다. Mod::beginProfile()와 Mod::endProfile() 호출이 올바르게 중첩되어 있는지 확인하십시오.',
  ...
  'Mod application can only be created once.' => 'Mod 응용 프로그램은 한 번만 만들 수 있습니다.',
