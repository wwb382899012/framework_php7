...
class CDbFixtureManager extends CApplicationComponent
{
	...
	public function init()
	{
		...
		if($this->basePath===null)
			$this->basePath=Mod::getPathOfAlias('application.tests.fixtures');
		$this->prepare();
	}
	...
	public function getDbConnection()
	{
		if($this->_db===null)
		{
			...
			if(!$this->_db instanceof CDbConnection)
				throw new CException(Mod::t('mod','CDbTestFixture.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
	...
	public function load($fixtures)
	{
		...
		foreach($fixtures as $fixtureName=>$tableName)
		{
			...
			{
				$modelClass=Mod::import($tableName,true);
