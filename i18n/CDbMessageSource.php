...
{
	const CACHE_KEY_PREFIX='Mod.CDbMessageSource.';
	/**
	...
	public function getDbConnection()
	{
		if($this->_db===null)
		{
			$this->_db=Mod::app()->getComponent($this->connectionID);
			if(!$this->_db instanceof CDbConnection)
				throw new CException(Mod::t('mod','CDbMessageSource.connectionID is invalid. Please make sure "{id}" refers to a valid database application component.',
